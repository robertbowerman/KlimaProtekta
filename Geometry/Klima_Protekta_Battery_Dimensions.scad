...
18650LithiumIonCellWeight = 38; // Grams
18650LithiumIonCellCost = 1.34; // Pounds I paid for one
...
echo("Actual rectangular battery overall dimensions", batteryLengthThreeParallelMM, "MM Y length *", actualBatteryYHorizontalAxisWidthMM, "MM X width *", chassisInternalSpaceVerticalMM, "MM Z height *");
...
echo("Weight of one battery pack - kg", actalBatteryTotalCellsQty * 18650LithiumIonCellWeight /1000);
echo("Weight of three battery packs - kg", 3 * actalBatteryTotalCellsQty * 18650LithiumIonCellWeight /1000);

echo("Cost of one battery pack - £ inc VAT one off", 18650LithiumIonCellCost * actalBatteryTotalCellsQty );
echo("Weight of three battery packs - £ inc VAT one off", 3 * 18650LithiumIonCellCost * actalBatteryTotalCellsQty );

echo("Percentage price off for quantity");
